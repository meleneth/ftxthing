...
loot: add item drops
loot: add currency drops
recruitment: add party member recruiter. $100 to recruit a level one with no skills. recruitment: When the lowest member of a party attains level 10, a new player slot opens in that party until max 5
